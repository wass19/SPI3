...
#ifndef _LSTSDD_H                   /* pour l'inclusion conditionnelle */
#define _LSTSDD_H



#include "lstptr.h"     /* inclusion du fichier où est déclarée la structure de donnée retenue pour réaliser le TDA LISTE */
