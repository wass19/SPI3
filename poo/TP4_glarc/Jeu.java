...
* @version 0.1 : Date : Tue Feb 06 09:08:23 CET 2018
*
*/
import java.util.*;
import java.lang.*;
...
public class Jeu{
	...
	public Jeu(){
		...
		plateau.setCase(new CaseObstacle(3,2),3,2);
		plateau.setCase(new CaseObstacle(1,6),1,6);
		plateau.setCase(new CaseObstacle(2,6),2,6);
		plateau.setCase(new CaseObstacle(5,6),5,6);
		plateau.setCase(new CaseObstacle(6,6),6,6);
		...
		listeGlark.add(new Pirate((CaseLibre)plateau.getCase(4,3)));
		listeGlark.add(new Pirate((CaseLibre)plateau.getCase(5,4)));
		listeGlark.add(new Pirate((CaseLibre)plateau.getCase(1,7)));

		listeGlark.add(new Glouton((CaseLibre)plateau.getCase(3,6)));
		listeGlark.add(new Glouton((CaseLibre)plateau.getCase(5,5)));
